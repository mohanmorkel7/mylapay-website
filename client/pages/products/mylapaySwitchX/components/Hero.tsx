...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://videocdn.cdnpk.net/videos/ba46798a-a0ff-50f7-b46e-69ed87b4849f/horizontal/previews/watermarked/large.mp4",
  ];
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay  
            ...
            a dynamic payment orchestration layer that puts the power of precision routing in your hands.
