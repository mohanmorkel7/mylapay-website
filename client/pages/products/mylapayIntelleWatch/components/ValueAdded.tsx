...
const features = [
  ...
  },
  {
    ...
    desc: "Access transaction flag, daily anomaly reports, and settlement insights for continue risk visibility.",
                  ...
                  >
                    ...
                    >
                     We’ve built the tools <br/>so you can manage smarter,
                      <br />
                     <span className="secondarycolormylapay" >every step of the way</span>
                    </motion.h2>
                  </motion.div>
                </div>
