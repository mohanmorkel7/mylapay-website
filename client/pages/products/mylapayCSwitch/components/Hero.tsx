...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://www.shutterstock.com/shutterstock/videos/1039688450/preview/stock-footage--d-concept-of-online-banking-on-mobile-phone-showing-services-currencies-and-graphs-beautiful.mp4",
  ];
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            ...
            Switch to smarter  speedier and safer payments with Mylapay CardSwitch,  <br /> delivering high success rate.
