...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://www.shutterstock.com/shutterstock/videos/1081905416/preview/stock-footage-omni-channel-technology-of-online-retail-business-method-multichannel-marketing-on-social-media.mp4",
  ];
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            ...
            <p className="text-[#2cade3] mt-2 ">Certified By NPIC</p>
          </Reveal>
