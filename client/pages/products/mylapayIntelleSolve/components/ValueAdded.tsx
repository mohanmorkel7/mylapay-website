...
const features = [
  ...
  {
    title: "Merchant Communication Automation",
    desc: "Streamlined document exchange and audit trails -- no follow-ups needed.",
    icon: <Globe className="w-8 h-8 text-white" />,
  },
  {
    title: "Full Lifecycle Tracking",
    desc: "From retrieval to representation to arbitration -- every case is tracked with precision.",
