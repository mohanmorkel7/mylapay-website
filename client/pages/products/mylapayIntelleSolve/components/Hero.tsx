...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://videocdn.cdnpk.net/videos/5724a0cd-80a4-54bd-876b-dfc3cc34f058/horizontal/previews/watermarked/large.mp4",
  ];
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          >A fully automated and card network-compliant dispute management solution for banks, acquirers, and payment aggregators. It streamlines workflows for all categories of disputes—from the initial chargeback to arbitration—and ensures recovery
          </Reveal>
