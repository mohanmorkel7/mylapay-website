...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://videocdn.cdnpk.net/videos/3be49d61-ef6c-4107-9521-ddab4afb3757/horizontal/previews/watermarked/large.mp4",
  ];
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay 
            ...
            Industry-first analytics for acquiring payment business Delivering complete financial protection and drive profits for every payment you acquire.
