...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://videocdn.cdnpk.net/videos/f7960e48-c3b8-5b21-ab9d-065f237a334a/horizontal/previews/watermarked/large.mp4",
  ];
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            <span className="text-[#2cade3]"> 3DSecure </span>
