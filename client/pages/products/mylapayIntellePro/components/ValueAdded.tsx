...
const ValueAdded = () => {
  ...
  return (
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      className="p-6 cursor-default flex flex-col items-center lg:items-start"
    >
      <motion.h2
        whileHover={{ scale: 1.05, color: "" }}
        transition={{ duration: 0.2, ease: "easeOut" }}
        className="text-4xl md:text-4xl font-bold mb-4 text-center  lg:text-center"
      >Built to keep your UPI payments
      <br />
      <p className="text-xl md:text-l font-semibold  mb-4 text-justify lg:text-center opacity-50"> fast,accurate and always on <br/><span className="secondarycolormylapay text-2xl font-bold ">- no matter the volume</span></p>
