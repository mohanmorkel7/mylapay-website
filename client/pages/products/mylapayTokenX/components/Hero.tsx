...
import HeroVideo from "@/pages/assets/videos/index_hero.mp4"
 ...
 // Dummy video list to cycle through as background (public sample clips)
  const videoList = [
    "https://videocdn.cdnpk.net/videos/ac2eb853-c9d8-52e1-abf0-99385cdbae09/horizontal/previews/watermarked/large.mp4",
  ];
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay 
            ...
            {/* <br /> */}
            card platform unified for all networks
            <p className="text-[#2cade3] mt-2 ">COFT & Alt ID Complaint</p>
          </Reveal>
