            ...
            {features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  {/* Icon Badge */}
                  <motion.div
                    animate={isAutoHighlighted ? { scale: 1.1 } : { scale: 1 }}
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.4 }}
                    className={`p-4 sm:p-5 rounded-2xl text-center backdrop-blur-sm shadow-sm border transition-colors duration-500
                      ...
                      ${
                        isHovered || isAutoHighlighted
                          ? "bg-gradient-to-br from-[#f0f9ff] to-[#] border-blue-300"
...
//                       ${
//                         isHovered || isAutoHighlighted
//                           ? "bg-gradient-to-br from-[#2cade3] to-[#1f2b5c] border-blue-300 shadow-[0_0_10px_rgba(44,173,227,0.7)]"
//                           : "bg-gray-100 border-gray-300"
//                       }`}
//                   >
//                     <Icon
...
//                   {/* Product Card */}
//                   <motion.div
//                     animate={isAutoHighlighted ? { scale: 1.02 } : { scale: 1 }}
//                     transition={{ duration: 0.4 }}
//                     className={`p-4 sm:p-5 rounded-2xl text-center backdrop-blur-sm transition-all duration-500
//                       w-full max-w-[280px] sm:max-w-[300px] md:max-w-[340px] lg:max-w-[360px] 
//                       min-h-[100px] sm:min-h-[120px] md:min-h-[140px] flex flex-col justify-between
//                       ${
//                         isHovered || isAutoHighlighted
//                           ? "bg-white border border-blue-400 shadow-[0_0_12px_rgba(44,173,227,0.6)]"
